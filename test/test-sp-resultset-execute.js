...
const proc2 = 'create procedure ' + schema + '.proc2 ( v1 int, INOUT v2 varchar(30)); ' + "let v2='success';" + 'end procedure;';
const proc3 = 'create procedure ' + schema + '.proc2 ( v1 int, v2 varchar(30)) returning int,varchar(20); ' + "return 1,'bimal' with resume;" + "return 2,'kumar' with resume; end procedure;";
const query = '{call proc2(?, ?)}';
